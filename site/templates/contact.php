...
<div class="main-container">
    <div class="main">
        <section class="wrapper">
            ...
            <p class="lead-email"><a class="" href="mailto:hello@designabile.com"><i class="ss-icon icon-big">email</i> hello@designabile.com</a></p>
            <div class="span-3">
                <h2>Address</h2>
                <p> You'll find Designabile studio sitting down in Prati, a small, little-know district close to Rome centre.</p>
                    
                    <p>Designabile<br>
                    Via della Giuliana 80<br> 00195 Rome, ITALY
