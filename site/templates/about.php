       ...
       <section class="wrapper cf section-about"> 
            ...
            <div class="span-4">
                ...
                <section class="span">
                    ...
                    <dl>
                        <dt><a href="#">Interface Design</a></dt>
                        <dd> HTML.IT <span>IT</span>
                            <em>(April 2009)</em>
                        </dd>
                        <dt><a href="#">Create a simple tab widget</a></dt>
                        <dd> HTML.IT <span>IT</span>
                            <em>(April 2009)</em>
                        </dd>
                        <dt><a href="#">CSS Solutions for IE6</a></dt>
                        <dd> HTML.IT <span>IT</span>
                            <em>(April 2009)</em>
                        </dd>
                    </dl>
